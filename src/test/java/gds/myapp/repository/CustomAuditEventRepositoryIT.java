...
import gds.myapp.config.audit.AuditEventConverter;
import gds.myapp.domain.PersistentAuditEvent;
...
import static gds.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
